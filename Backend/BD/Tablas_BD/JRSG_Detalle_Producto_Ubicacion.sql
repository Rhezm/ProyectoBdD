create table JRSG_Detalle_Producto_Ubicacion ( --- Se Actualizo, se quito id_inventario.
    id_producto number,
    id_ubicacion number,

    constraint PK_Detalle_Inventario_Producto_Ubicacion primary key (id_producto, id_ubicacion),
