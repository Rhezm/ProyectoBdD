create or replace procedure JRSG_Pro_Crear_Producto (
    ...
    begin
        ...
        if (contador > 0) then
            ...
            insert into JRSG_Producto (id_producto, id_categoria, id_promocion, nombre_producto, descripcion_producto, precio, stock)
            values (JRSG_Sec_Generar_ID_Productos.nextval, id_categoria_p, id_promocion_p, nombre_producto_p, descripcion_producto_p, precio_p, stock_p);
